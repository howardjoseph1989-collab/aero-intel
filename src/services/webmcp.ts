...
const TOOL_FAILURE_MESSAGES: Record<WebMcpSpaToolName, string> = {
  openCountryBrief: 'AERO INTEL could not open that country brief.',
  openSearch: 'AERO INTEL could not open search.',
  get_dashboard_context: 'AERO INTEL could not read dashboard context.',
  list_map_layers: 'AERO INTEL could not list map layers.',
  list_dashboard_panels: 'AERO INTEL could not list dashboard panels.',
  switch_monitor: 'AERO INTEL could not switch monitors.',
  open_settings: 'AERO INTEL could not open settings.',
  open_alerts: 'AERO INTEL could not open alerts.',
  open_dashboard_panel: 'AERO INTEL could not open that dashboard panel.',
  set_panel_enabled: 'AERO INTEL could not update that dashboard panel.',
  get_panel_layout: 'AERO INTEL could not read the panel layout.',
  set_panel_collapsed: 'AERO INTEL could not update that panel collapse state.',
  move_panel: 'AERO INTEL could not move that panel.',
  set_panel_fullscreen: 'AERO INTEL could not update that panel fullscreen state.',
  set_map_view: 'AERO INTEL could not move the map.',
  set_map_layers: 'AERO INTEL could not update map layers.',
  set_time_range: 'AERO INTEL could not set the map time range.',
  focus_country: 'AERO INTEL could not focus that country.',
  set_map_mode: 'AERO INTEL could not switch the map mode.',
  search_dashboard: 'AERO INTEL could not search the dashboard.',
  open_search_result: 'AERO INTEL could not open that search result.',
  list_dashboard_tabs: 'AERO INTEL could not list dashboard tabs.',
  select_dashboard_tab: 'AERO INTEL could not select that dashboard tab.',
  create_dashboard_tab: 'AERO INTEL could not create that dashboard tab.',
  rename_dashboard_tab: 'AERO INTEL could not rename that dashboard tab.',
  delete_dashboard_tab: 'AERO INTEL could not delete that dashboard tab.',
  list_mission_presets: 'AERO INTEL could not list mission presets.',
  apply_mission_preset: 'AERO INTEL could not apply that mission preset.',
  open_mission_picker: 'AERO INTEL could not open the mission picker.',
  list_followed_countries: 'AERO INTEL could not list followed countries.',
  set_country_followed: 'AERO INTEL could not update that followed country.',
  get_access_context: 'AERO INTEL could not read access context.',
  open_sign_in: 'AERO INTEL could not open sign-in.',
};
export const WEBMCP_UNSUPPORTED_CANCELLATION_MESSAGE =
  'This browser cannot cancel work already running in the page, so AERO INTEL '
