...
export const COMMANDS: Command[] = [
  ...
  { id: 'panel:us-local', keywords: ['us local', 'local news', 'metro news', 'city news'], label: 'Panel: US Local', icon: '\u{1F3D9}\uFE0F', category: 'panels' },
  { id: 'panel:politics', keywords: ['world news', 'politics', 'geopolitics', 'international'], label: 'Panel: World / International', icon: '\u{1F30D}', category: 'panels' },
  { id: 'panel:us', keywords: ['united states', 'us news', 'america news', 'us national'], label: 'Panel: US National', icon: '\u{1F1FA}\u{1F1F8}', category: 'panels' },
  ...
  { id: 'panel:africa', keywords: ['africa news', 'africa', 'african', 'sahel'], label: 'Panel: Africa', icon: '\u{1F30D}', category: 'panels' },
  { id: 'panel:latam', keywords: ['latin america news', 'latam news', 'latin america', 'south america'], label: 'Panel: Latin America', icon: '\u{1F30E}', category: 'panels' },
  { id: 'panel:asia', keywords: ['asia news', 'asia-pacific news', 'asia', 'asia pacific', 'indo-pacific'], label: 'Panel: Asia-Pacific', icon: '\u{1F30F}', category: 'panels' },
  ...
  { id: 'panel:oil-inventories', keywords: ['oil inventories', 'crude stocks', 'strategic petroleum', 'spr', 'petroleum reserve', 'oil stocks', 'eia inventories', 'iea stocks', 'days of cover', 'oil reserves', 'gas storage'], label: 'Panel: Oil Inventories', icon: '\u{1F6E2}\uFE0F', category: 'panels' },
  ...
  { id: 'panel:gov', keywords: ['government', 'gov', 'policy', 'legislation'], label: 'Panel: Government', icon: '\u{1F3DB}\uFE0F', category: 'panels' },
  ...
  { id: 'panel:stock-analysis', keywords: ['stock analysis', 'equity analysis', 'premium stocks'], label: 'Panel: Stock Analysis', icon: '\u{1F4C8}', category: 'panels' },
  ...
  { id: 'panel:nq-pulse', keywords: ['nq pulse', 'nasdaq futures', 'emini nasdaq', 'nq=f', 'vxn', 'qqq context'], label: 'Panel: NQ Pulse', icon: '\u{1F4C8}', category: 'panels' },
  { id: 'panel:nq-catalysts', keywords: ['nq catalysts', 'nasdaq earnings', 'us macro calendar', 'fomc nq', 'influence basket'], label: 'Panel: NQ Catalysts', icon: '\u{1F4C5}', category: 'panels' },
  ...
  { id: 'panel:bonds', keywords: ['bonds', 'fixed income', 'treasuries', 'yield'], label: 'Fixed Income', icon: '\u{1F4B3}', category: 'panels' },
  { id: 'panel:forex', keywords: ['forex', 'currencies', 'fx', 'exchange rates'], label: 'Forex & Currencies', icon: '\u{1F4B1}', category: 'panels' },
  { id: 'panel:derivatives', keywords: ['derivatives', 'options', 'futures', 'swaps'], label: 'Derivatives & Options', icon: '\u{1F4C9}', category: 'panels' },
  ...
  { id: 'panel:economic-news', keywords: ['economic news', 'economy news', 'macro news', 'gdp news'], label: 'Economic News', icon: '\u{1F4F0}', category: 'panels' },
  { id: 'panel:commodities-news', keywords: ['commodities news', 'commodity markets news', 'raw materials news'], label: 'Commodities News', icon: '\u{1F4F0}', category: 'panels' },
  { id: 'panel:crypto-news', keywords: ['crypto news', 'bitcoin news', 'blockchain news', 'defi news'], label: 'Crypto News', icon: '\u{1F4F0}', category: 'panels' },
  { id: 'panel:gccNews', keywords: ['gcc news', 'gulf news', 'saudi news', 'uae news', 'middle east business'], label: 'GCC Business News', icon: '\u{1F1F8}\u{1F1E6}', category: 'panels' },

  // Commodity variant panels
  { id: 'panel:commodity-news', keywords: ['commodity news', 'mining news', 'resource news'], label: 'Commodity News', icon: '\u{1F4F0}', category: 'panels' },
  { id: 'panel:mining-news', keywords: ['mining news', 'mineral news', 'mining industry'], label: 'Mining News', icon: '\u26CF\uFE0F', category: 'panels' },
  { id: 'panel:mining-companies', keywords: ['mining companies', 'miners', 'mining stocks'], label: 'Mining Companies', icon: '\u{1F3ED}', category: 'panels' },
