...
Facts reconciled: 2026-09-09 — see Data Coverage below for how each figure is derived.
...
Coverage reconciled: 2026-09-09. Every figure below is generated from this repository's authoritative registries by `npm run build:ai-search` — the same registries that produce https://www.worldmonitor.app/sources/.
...
- 736 feed definitions in the shared feed registry — distinct from the 461 feed-publishing hosts above, since one host can back several feed definitions
